...
const Login = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 h-216 z-10 backdrop-blur-sm bg-black/30 flex  justify-center items-center">
      <motion.form 
      onSubmit={onSubmitHandler}
       ...
       viewport={{once:true}}
      className="relative bg-white p-10 rounded-xl mb-30 text-slate-500"
...
<img onClick={()=>setShowLogin(false)} src={assets.cross_icon} width={14} alt="" className="absolute top-5 right-5 cursor-pointer"/>
      </motion.form>
    </div>
  );
};
