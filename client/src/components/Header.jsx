    ...
    >
      ...
      animate={{ opacity: 1, y: 0 }}
       transition={{delay:0.6, duration: 0.8}}
        >
       Transform words into visuals instantly. Watch your ideas turn into stunning images with the power of AI.
      </motion.p>
      <motion.button 
      onClick={onClickHandler}
      className="sm:text-lg text-white bg-black w-59 h-12 mt-8 px-9 py-2. lg:px-9 sm:py-1 flex items-center gap-2 rounded-full"
